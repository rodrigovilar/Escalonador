...
public class FachadaEscalonadorRoundRobinTest {
	...
	@Test
	public void t04_finalizarProcessoEmExecu��o() {
		fachada.adicionarProcesso("P1");
		ticks(fachada, 4);
	...
	@Test
	public void t05_alternarDoisProcessosEmExecu��o(){
		fachada.adicionarProcesso("P1");
	...
	@Test
	public void t06_alternarDoisProcessosEmExecu��o(){
	...
	@Test
	public void t07_alternarDoisProcessosEmExecu��oInicioDiferente(){
		fachada.adicionarProcesso("P1");
	...
	@Test
	public void t08_finalizarProcessoEmExecu��o() {
		fachada.adicionarProcesso("P1");
		fachada.adicionarProcesso("P2");
		fachada.adicionarProcesso("P3");
	...
	@Test
	public void t12_bloqueioProcessoEmExecu��o() {
		fachada.adicionarProcesso("P1");
		fachada.adicionarProcesso("P2");
		fachada.adicionarProcesso("P3");
